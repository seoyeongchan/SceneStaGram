...
//유저,해쉬 검색시 옵션
const searchSelectOption = document.querySelector('#option')

const sidebarsearchValue = document.querySelector('#searchValue')

function creanSearchVal(){
	sidebarsearchValue.value = '';
	searchOptionHandler()
}

searchSelectOption.onchange = creanSearchVal