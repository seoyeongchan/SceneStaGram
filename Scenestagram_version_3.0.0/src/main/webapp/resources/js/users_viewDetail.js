...
function checkFollowHandler() {
   if(dto_idx == users_idx) {
         followBtn.innerHTML = '<a href="' + cpath + '/users/infoModify" style="color: black;">프로필 편집</a>'
         followBtn.classList.add('modiPro')   // 나중에 프로필 편집 버튼에 속성 추가가 필요할까?
         followBtn.style.backgroundColor = 'rgb(239,239,239)'         
      }
   else {
