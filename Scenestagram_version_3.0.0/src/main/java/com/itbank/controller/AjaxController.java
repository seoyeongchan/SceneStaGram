...
// 검색결과에 대한 게시글의 카운트 개수 반환
 ...
 // 뷰 디테일 페이지의 포스트 수 반환
    ...
    @GetMapping("/getNickNameUser/{nick_name}")
    public UsersDTO getNickNameUser(@PathVariable("nick_name") String nick_name) {
    	UsersDTO dto = userService.getNickNameUser(nick_name);
    	return dto;
    }
