...
public class UsersController {
	...
	public String login(UsersDTO dto, HttpSession session , RedirectAttributes rttr) {
		...
		if(login != null && login.getStatus().equals("deactivate")) {
...
// 02-08
	...
	@ResponseBody
	public String getUserIDXByNickName(@PathVariable("nick_name") String nick_name) {
		String idx = usersService.getUserIDXByNickName(nick_name);
		return idx;
	}
